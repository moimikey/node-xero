...
var fetch = exports.fetch = (function () {
  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(path) {
    var appType, consumerKey, consumerSecret, _apiConfig$appType, apiUrl, requestTokenUrl, accessTokenUrl, authorizeUrl, oauthVersion, signatureMethod, oa, getRequestOptions, getRequestToken, getAccessToken, getAuthorization, requestPublic, requestPrivate, requestPartner;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            getRequestOptions = function getRequestOptions() {
              ...
              return (_Object = Object).assign.apply(_Object, [Object.create(null), {
                url: apiUrl + '/' + path
              }].concat(options));
            };
